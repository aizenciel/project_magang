    ...
    <body class="font-sans antialiased">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <x-nav-link :href="route('admin.checkout.index')" :active="request()->routeIs('admin.checkout.*')">
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                links.forEach(link => {
                    if (link.textContent.includes('Add New Item')) {
                        console.log('Found Add New Item link:', link.href);
                        link.addEventListener('click', function(e) {
                            console.log('Add New Item link clicked');
                        });
                    }
                });
            });
